    ...
    const steps = [
        {
            n: "01",
            t: "Validate",
            d: "A vision LLM checks every upload before anything else: does the image match the selected pipeline (e.g. is this actually a brain MRI / lung CT)? Photos, paper, X-rays — they get rejected with a reason.",
        },
        {
            n: "02",
            t: "CNN classify",
        ...
        },
        {
            n: "03",
            t: "Reason",
            d: "Claude Sonnet 4.5 sees both the image and the CNN's verdict, then drafts a structured report: observations, key indicators, recommendations, and a triage urgency.",
        },
    ];
    return (
        <section
